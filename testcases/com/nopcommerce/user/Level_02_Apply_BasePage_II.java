...
public class Level_02_Apply_BasePage_II {
	...
	public void TC_02_Register_With_Invalid_Email() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Curry");
		basePage.sendkeyToElement(driver, "//input[@id='LastName']", "Pham");
		basePage.sendkeyToElement(driver, "//input[@id='Email']", "curry.test#23443alpaca.com");
	...
	public void TC_05_Register_With_Password_Less_Than_6_Character() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Curry");
		basePage.sendkeyToElement(driver, "//input[@id='LastName']", "Pham");
		basePage.sendkeyToElement(driver, "//input[@id='Email']", "curry.test2134324@alpaca.com");
	...
	public void TC_06_Register_With_Invalid_Confirm_Password() {
		...
		basePage.sendkeyToElement(driver, "//input[@id='Email']", "curry.test2134324@alpaca.com");
		basePage.sendkeyToElement(driver, "//input[@id='Password']", "123456");
		basePage.sendkeyToElement(driver, "//input[@id='ConfirmPassword']", "654342");
