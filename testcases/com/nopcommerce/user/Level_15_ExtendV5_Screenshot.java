...
public class Level_15_ExtendV5_Screenshot extends BaseTest {
	...
	public void User_01_Register(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 08: Verify register success mesage is displayed");
	...
	public void User_02_Login(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 02: Enter to Email Address textbox with value is '" + emailAddress + "'");
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 05: Verify login success mesage is displayed");
		Assert.assertEquals(homePage.getSuccessLogin(), "My account..");

		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 06: Navigate to 'Customer infor page'");
